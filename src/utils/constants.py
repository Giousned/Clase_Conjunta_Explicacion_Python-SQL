...
"""
Constantes para nuestra app
docstring -> informacion auxiliar que aparecerá en el IDE
"""
# TIPOS DE DATOS
...
DAFAULT_QUANTITY_TO_ALERT = 1_000_000
...
MOCKUP_PRODUCTS_LIST = ["Fregona", "Cereales"]

# TUPLES

MOCKUP_PRODUCTS_TUPLES = ("Fregona", "Cereales")
...
# MOCKUP_PRODUCTS_LIST[0] = ['Fregonaaa'] Lo Puedo cambiar# TUPLES

MOCKUP_CUPONS = {'Comida a mitad de precio', 'Productos sin IVA'}# Esto no se puede modificar como las LISTS, habría que hacer lo siguiente si queremos modificarla
...
[primer_producto, *segundo_producto] = MOCKUP_PRODUCTS_LIST# Se puede hacer igual con tuplas solo que usando paréntesis# SET
...
# 
# # OBJETOS OBJECTS VS DICTIONARIES# JAVASCRIPT - OBJECT LITERALS!!!!!
# const myObject = {
#     key1: 'value1'
# }
...
def find_object_in_list(target_list=None, key=None, value=None):
    '''Finds an object in a list given its desired key and value
        ...
        Arguments :
        - target_list: lista donde quiero buscar
...
# def create_product():
#     product = {}
#     MOCKUP_PRODUCTS.append(product)
